...
public class VisitasAdapter extends ListAdapter<InfoTarjetaVisita, VisitasAdapter.ViewHolder> {
    VisitasViewModel vm;
    public VisitasAdapter(VisitasViewModel vm) {
    ...
    @NonNull
    @Override
    public VisitasAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new VisitasAdapter.ViewHolder(
